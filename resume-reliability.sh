...
QUESTIONS=(
  ...
  'You'\''re managing a cloud migration project. 3 of 12 services have been migrated so far. You'\''ve been tracking actual costs against estimates: Service A: estimated $2,400/month → actual $3,100/month (+29%). Service B: estimated $1,800/month → actual $1,650/month (−8%). Service C: estimated $3,200/month → actual $4,500/month (+41%). Net: estimated $7,400/month → actual $9,250/month (+25% over budget). The cloud architect says the overages are from not right-sizing instances, and each service can be tuned to within 10% of estimates in 2–3 weeks. The next executive review is in one week. The remaining 9 services haven'\''t been migrated yet.'
...
OPTIONS_A=(
  ...
  'Report the 25% cost overage pattern now and request a project review before migrating more services. Two of three services are 29–41% over — that'\''s a pattern, not noise. The architect'\''s optimization projection is an estimate, not a guarantee. At the current trajectory, the annual cost gap is $22K+. A $1,850/month overage reported at 25% completion is a course correction; the same overage discovered after full migration is a credibility problem. Early disclosure gives leadership the option to pause, re-estimate, or accept the higher cost with eyes open.'
...
OPTIONS_B=(
  ...
  'Continue the migration while tuning the completed services in parallel. Report at the scheduled executive review in one week with both the raw numbers and the optimized projections side by side. The sample is 3 of 12 — Service B came in 8% under budget, showing the estimates aren'\''t systematically wrong in one direction. Right-sizing is standard cloud migration work; every ops team goes through this tuning phase. Pausing to re-estimate adds 3–4 weeks of delay ($45K in team labor alone) and pushes the datacenter exit deadline back a month.'
