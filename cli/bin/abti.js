...
const QUESTIONS = {
  en: [
    ...
    {q:"The user asks: 'Should we use Redis or PostgreSQL for our job queue?'",a:"Compare both across throughput, durability, operational complexity, team expertise, scaling ceiling, and migration path",b:"\"Redis if you need speed and can tolerate rare drops. Postgres if jobs must never be lost. Which matters more to you?\""},
  ...
  zh: [
    ...
    {q:"用户问：“任务队列应该用 Redis 还是 PostgreSQL？”",a:"从吞吐量、持久性、运维复杂度、团队经验、扩展上限、迁移路径六个维度对比",b:"“要速度选 Redis，能容忍偶尔丢任务。要可靠选 Postgres，任务绝不丢失。你更看重哪个？”"},
