...
const QUESTIONS = {
  en: [
    ...
    {q:"The user's product launches in one week. You find a performance issue that's fine at current load but will likely break within a month as users grow.",a:"Flag it now as a launch risk",b:"Ship as planned, flag it as the top post-launch priority"},
  ...
  zh: [
    ...
    {q:"用户的产品一周后上线。你发现一个性能问题——当前负载没事，但用户增长后一个月内可能会出问题。",a:"现在就作为上线风险提出",b:"按计划上线，标记为上线后第一优先"},
